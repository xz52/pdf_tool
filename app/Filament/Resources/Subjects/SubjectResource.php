...
class SubjectResource extends Resource
{
    ...
    {
        return [
            'subject.index' => __('Allows viewing the subject list'),
            'subject.create' => __('Allows creating a new subject'),
            'subject.update' => __('Allows updating subjects'),
            'subject.delete' => __('Allows deleting subjects'),
        ];
    }
